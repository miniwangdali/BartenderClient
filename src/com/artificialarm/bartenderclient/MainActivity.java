...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Dialog mit dem Wartezeichen f�rs Verbinden
	...
	// Discovering devices
	   final BroadcastReceiver bReceiver = new BroadcastReceiver() {
	        ...
	        public void onReceive(Context context, Intent intent) {
	            ...
	            // Anweisung, wenn kein Ger�t gefunden wird
	            else{
	            	...
	            	// schreibt in msg.what eine eins um zu sagen, dass das Ger�t nicht verbunden ist
	   ...
	   public void find() {
		   ...
		   // Anweisung: wenn schon nach Ger�ten gesucht wird abbrechen und neu starten, sonst Discovery starten -> Broadcast Receiver
	   ...
	   public void getConnection() throws IOException{
		  ...
		  //      Toast.makeText(getApplicationContext(), "Now your device is connected", Toast.LENGTH_LONG).show();*/
		        ...
		        // schreibt die null in msg.what -> Handler, gibt aus das das Ger�t verbunden ist
		        Message msg = new Message();
		        msg.what = 0;
		        handler.sendMessage(msg);
		}
